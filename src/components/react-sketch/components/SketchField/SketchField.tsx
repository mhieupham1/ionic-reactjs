...
class SketchField extends PureComponent {
    ...
    addImg = (dataUrl, options = {}) => {
        ...
        //
        // this.setBackgroundFromDataUrl(dataUrl, {
        //     stretched: stretched,
    ...
    positionBtn = (obj) => {
        ...
        let canvas = this._fc;
        let btn = document.getElementById('test-text'),
            btnWidth = 85,
            btnHeight = 18;
    ...
    componentDidMount = () => {
        ...
        fabric.Canvas.prototype.getObjectWithOutTypeObjectName = function(name) {
            var objectList = [],
                objects = this.getObjects();

            for (var i = 0, len = this.size(); i < len; i++) {
                if (objects[i].typeObject && objects[i].typeObject !== name) {
