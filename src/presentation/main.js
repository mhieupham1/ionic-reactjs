...
const changeImage = (objectVal) => {
  console.log(_presentation.connection)

  if (_presentation.connection) {
    _presentation.connection.send(objectVal);
  }
};
...
const displayConnected = () => {
  ...
  // _buttons.connect.removeEventListener('click', connectDisplay, true);
